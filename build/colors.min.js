...
*/
(function(){var b,c,d,a;d=function(e,s,q,t,m,l){var n,u,o,f,r,p,j,i,k,g;if(l==null){l=8}o=e.getContext("2d").getImageData(s,q,t,m).data;f=[];for(p=j=q,k=q+m;j<k;p=j+=1){u=p*t*4;for(r=i=s,g=s+t;i<g;r=i+=1){n=u+(r*4);f.push([o[n],o[n+1],o[n+2]])}}return(new MMCQ).quantize(f,l)};c=function(f,e){var g;g=function(h){return h*h};return g(f[0]-e[0])+g(f[1]-e[1])+g(f[2]-e[2])};a=function(h,k,m){var f,j,e,i,l,g;if(m==null){m="color"}j=document.getElementsByClassName(k);h="rgb("+h[0]+", "+h[1]+", "+h[2]+")";g=[];for(i=0,l=j.length;i<l;i++){f=j[i];e=f.getAttribute("style");g.push(f.setAttribute("style",""+e+" "+m+": "+h+";"))}return g};this.color=function(g,f,h){var e,i;i=new Image;i.src=g;e=document.getElementById(f);return window.onload=function(){var n,l,m,o,p,k,j;i.height=Math.round(i.height*(300/i.width));i.width=300;e.width=i.width;e.height=i.height;e.getContext("2d").drawImage(i,0,0,i.width,i.height);l=d(e,0,0,i.width,i.height,10);j=l.cboxes.map(function(q){return{count:q.cbox.count(),rgb:q.color}});j.sort(function(r,q){return q.count-r.count});n=j.shift().rgb;m=function(q){return c(n,q.rgb)};k=j;j.sort(function(r,q){return m(q)-m(r)});o=k.shift().rgb;p=k.shift().rgb;console.log([n,o,p]);a(n,h.bgClass,"background-color");a(o,h.fgClass,"background-color");return a(p,h.fgClass2,"background-color")}};
/*
